...
- 加入音效。全部用 Web Audio 即時合成,沒有任何外部音檔,單一 HTML 不變
- 15 種聲音:出筆、命中、化墨、拾墨、添筆、受傷、潑墨落地、驚電、墨龍、紙甲成形與破碎、墨王登場、祭壇、勝負
- 高頻音效(出筆/命中/化墨/拾墨/驚電)有最短間隔節流,同時發聲數上限 22,不會爆音
- 設定頁多一個音效開關
- 瀏覽器規定要有使用者動作才能出聲,所以第一次點畫面或按鍵時才啟動
